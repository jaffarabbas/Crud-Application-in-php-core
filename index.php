...
<body>
    <section class="container">
      ...
      <option>Not spesifide</option>
            ...
            <div class="form-group">
                ...
                <input type="number"  step="0.0001" class="form-control" id="f3" placeholder="Salary" name="salary">
            </div>
            <div class="form-group">
    ...
    <div><a class="btn btn-primary" id="ancor_btn" href="table.php">View Insertion</a></div>
